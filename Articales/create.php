...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) > 0) {
        ...
        if (move_uploaded_file($ImgTempPath, $disPath)) {
            ...
            $sql = "insert into articals (title,content,date,image,addedBy) values ('$title','$content',$date,'$FinalName',$userId)";
...
<main>
    <div class="container-fluid">
        <ol class="breadcrumb mb-4">
            <h2 class="breadcrumb-item active">Articales/Create</h2>
